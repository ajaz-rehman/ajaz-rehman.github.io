...
export const TESTIMONIALS = [
	{
		...
		socialNetworks: [
			{ name: "Linkedin", url: "https://linkedin.com/in/diparatisen" },
			{
				name: "Instagram",
				url: "https://instagram.com/__a.girl.can.dream__",
			},
		],
	...
	},
	{
		...
		socialNetworks: [
			{ name: "Linkedin", url: "https://linkedin.com/in/lucasinfante" },
			{
				name: "Instagram",
				url: "https://instagram.com/lucasinfante",
			},
		],
	...
	},
	{
		...
		socialNetworks: [
			{ name: "Linkedin", url: "https://linkedin.com/in/lisa-schumann" },
			{
				name: "Instagram",
				url: "https://instagram.com/lisaschumann",
			},
		],
	...
	},
	{
		...
		socialNetworks: [
			{ name: "Linkedin", url: "https://linkedin.com/in/soumilroy" },
			{
				name: "Instagram",
				url: "https://instagram.com/soumilroy",
			},
		],
		text: "Ajaz is one of those rare developers you come across in life when it comes to superb skills & problem solving. He is incredibly quick to learn and adapt anything you throw at his way. Having worked with him for last 6 months, I can vouch for his dedication and passion.",
	},
];
